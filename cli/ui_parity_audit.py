...
CHECKS: tuple[ParityCheck, ...] = (
    ...
    ParityCheck(
        ...
        backend_tokens=("hermes_gateway", "hermes_gateway_health"),
        ui_tokens=("Hermes Gateways", "ai.hermes.gateway"),
        backend_paths=("/brain/ops/readiness",),
        api_client_paths=("/brain/ops/readiness",),
        readiness_fields=readiness_fields_for("hermes_gateway"),
        rationale="Automated agent work depends on Hermes profile gateway health; dashboard must show it.",
    ),
    ParityCheck(
        id="graph_stats",
