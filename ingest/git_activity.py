...
def build_distillation_prompt(daily_logs: list[dict]) -> str:
    ...
    lines.append('{"keep": [{"index": <int>, "summary": "<1-3 sentences>", "signal_type": "feature|bugfix|architecture|refactor|infra", "signal_score": <1-10>}], "skip_reason": "<why others were skipped>"}')
    lines.append('')
