...
- **Foundation**: `pyproject.toml` + uv pinned (Python 3.14), `cli/brain_init.py` idempotent bootstrap, **156 pytest tests** + 7 integration + restart soak, ruff+bandit+pre-commit, local fswatch CI via `ai.brain.ci.plist`.
